...
func main() {
	...
	chatModel, err := openai.NewChatModel(ctx, &openai.ChatModelConfig{Model: "gpt-4o", APIKey: "xxx"})
...
If the tool is successful, present the weather report clearly.`,
	...
	events := as.Run(ctx, &adk.AgentInput{
		Msgs: []adk.Message{schema.UserMessage("bye")},
	})
