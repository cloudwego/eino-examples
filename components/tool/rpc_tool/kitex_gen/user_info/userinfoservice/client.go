...
type Client interface {
	GetUserInfo(ctx context.Context, req *user_info.GetUserInfoRequest, callOptions ...callopt.Option) (r *user_info.GetUserInfoResponse, err error)
}
...
func (p *kUserInfoServiceClient) GetUserInfo(ctx context.Context, req *user_info.GetUserInfoRequest, callOptions ...callopt.Option) (r *user_info.GetUserInfoResponse, err error) {
